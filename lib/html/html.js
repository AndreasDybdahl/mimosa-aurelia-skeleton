System.register([], function (_export) {
  ...
  function translate(load) {
    ...
    var code = [
    //"debugger;",
    "var generate = require('html/generate')['default'];", "var deps = [];"].concat(deps.map(function (dep, index) {
    ...
    })).concat(["", "module.exports = generate(" + escapeString(name, "single") + ", " + escapeString(source, "single") + ", deps);"]).join("\n");
