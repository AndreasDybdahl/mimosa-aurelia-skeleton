...
System.register(["aurelia-framework", "aurelia-templating", "app/resource-pool/services/resource-pool", "highlightjs", "srcref.json!"], function (_export) {
  var Behavior, Container, ViewCompiler, ViewResources, ViewSlot, ResourcePool, hljs, srcref, _prototypeProperties, _classCallCheck, hasTemplateElement, SampleBehavior;
                      ...
                      return Promise.all(_this.files.map(function callee$3$0(_ref) {
                        ...
                        return regeneratorRuntime.async(function callee$3$0$(context$4$0) {
                          while (1) switch (context$4$0.prev = context$4$0.next) {
                            ...
                            case 13:
                              lang = "js";return context$4$0.abrupt("break", 18);

                            case 15:
                              lang = "html";return context$4$0.abrupt("break", 18);

                            case 17:
                              throw new Error("Unknown extension: " + ext);

                            case 18:
                              highlight = hljs.highlight(lang, src, true).value;
                              return context$4$0.abrupt("return", { name: name, mod: mod, ext: ext, src: src, highlight: highlight, url: url, model: model, view: view, lang: lang });
