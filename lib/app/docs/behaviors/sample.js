    ...
    execute: function () {
      ...
      SampleBehavior = _export("SampleBehavior", (function () {
        function SampleBehavior(element, resourcePool, viewCompiler, viewResources, viewSlot, container) {
          ...
          this.files = [{ id: "./viewmodel", ext: ".js", name: "viewmodel" }, { id: "./template", ext: ".html", name: "template" }];
                      ...
                      return Promise.all(_this.files.map(function callee$3$0(_ref) {
                        ...
                        return regeneratorRuntime.async(function callee$3$0$(context$4$0) {
                          while (1) switch (context$4$0.prev = context$4$0.next) {
                            ...
                            case 11:
                              lang = Prism.languages.javascript;return context$4$0.abrupt("break", 16);

                            case 13:
                              lang = Prism.languages.markup;return context$4$0.abrupt("break", 16);
                            ...
                            case 16:
                              ...
                              return context$4$0.abrupt("return", { name: name, mod: mod, ext: ext, src: src, highlight: highlight, url: url });
