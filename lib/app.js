...
"use strict";
System.register("app/docs/behaviors/doc", ["aurelia-framework", "aurelia-templating", "app/resource-pool/services/resource-pool", "showdown"], function(_export) {
  var Behavior,
      Container,
      ViewCompiler,
      ViewResources,
            ...
            value: function bind(ctx) {
              ...
              this.view = this.resourcePool.get(pool, "view", function() {
                var viewFactory = _this.resourcePool.get(pool, "viewFactory", function() {
                  var markdown = _this.textContent;
...
System.register("srcref.json!github:systemjs/plugin-json@0.1.0", [], true, function(require, exports, module) {
  ...
  module.exports = {
    "src": "src",
    "view": "https://github.com/YoloDev/mimosa-aurelia-skeleton/blob/9e861170e7841c6bc502ad144f01c4b056546501/src"
  };
  global.define = __define;
  return module.exports;
});
