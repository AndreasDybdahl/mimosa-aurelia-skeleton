...
System.register("app/app.html!plugin-html/html", ["html/generate"], true, function(require, exports, module) {
  var global = System.global,
      __define = global.define;
  global.define = undefined;
  var generate = require('html/generate')['default'];
...
System.register("app/main", ["bootstrap/css/bootstrap.css!", "style/site.css!", "aurelia-framework", "aurelia-logging-console", "aurelia-bootstrapper"], function(_export) {
  "use strict";
  var LogManager,
      ConsoleAppender,
      bootstrap;
  return {
    setters: [function(_bootstrapCssBootstrapCss) {}, function(_styleSiteCss) {}, function(_aureliaFramework) {
      LogManager = _aureliaFramework.LogManager;
    }, function(_aureliaLoggingConsole) {
      ConsoleAppender = _aureliaLoggingConsole.ConsoleAppender;
