System.config({
  ...
  "bundles": {
    "lib/app": [
      ...
      "github:components/highlightjs@8.4.0/highlight.pack",
      "srcref.json!github:systemjs/plugin-json@0.1.0",
      "plugin-md/rt",
      "app/docs/samples/1/viewmodel",
      "app/docs/samples/2/viewmodel",
      ...
      "github:components/highlightjs@8.4.0",
      "app/docs/routes/index.md!plugin-md/md",
